...
import { dirname as dirname3, win32 as win322 } from "node:path";
...
function windowsAclProtector(deps) {
  ...
  return async (target, kind) => {
    try {
      ...
      const dir = kind === "dir" ? target : dirname3(target);
...
`);
      return 0;
    case "skipped":
      out(s.last_error === null || s.last_error === void 0 ? "Backfill was skipped (already running or queue empty).\n" : `Backfill was skipped: ${s.last_error}.
`);
      return 0;
  }
}
